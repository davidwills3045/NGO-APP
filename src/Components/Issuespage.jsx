        ...
        <div className="flexbox">
          <div className="flex1">
            ...
            <p>
              ...
              has <br />
              complimented our efforts by <br /> supporting some of these health{" "}
              <br />
              facilities with water borehole, <br /> power supply and the right
              caliber <br />
              of staff.
            </p>
          ...
          <div className="flex1">
            ...
            <p>
              In AHDC we believe that good <br /> sanitary and hygiene practices{" "}
              <br /> are key enablers of good health. <br /> But the two would
              be difficult <br /> without adequate and timely <br /> supply of
              water.
            </p>
            <button className="flexbox-btn">
              <img src={arrow} alt="" />
          ...
          <div className="flex1" id='third-flex'>
            <h3 className="flex1-h3" id='third-h'>Education</h3>
            <p id='third-p'>
              It is our belief that quality <br /> education can help to level{" "}
              <br /> economic and social <br /> inequalities, promote the <br />{" "}
              social mobility of people and <br /> people’s access to better{" "}
              <br /> levels of employment, <br /> amongst others.
            </p>
          ...
          <div className="flex1">
            ...
            <p>
              We recognize the centrality of <br /> just and good governance in{" "}
              <br /> community development, <br /> poverty eradication and{" "}
